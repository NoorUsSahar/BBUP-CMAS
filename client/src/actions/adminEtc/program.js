...
// Get all undergraduate and graduate programs
export const getAllPrograms = () => async dispatch => {
  try {
    const res = await axios.get('/api/programs/all');
...
// Get all undergraduate programs of a department
export const getDepartmentsAllUndergraduatePrograms = id => async dispatch => {
  try {
    const res = await axios.get(
      `/api/programs/undergraduate-programs/department/${id}`
    );

    dispatch({
      type: DEPARTMENT_UNDERGRADUATE_PROGRAMS_LOADED,
      payload: res.data
    });
  } catch (err) {
    dispatch({
...
// Get all graduate programs of a department
export const getDepartmentsAllGraduatePrograms = id => async dispatch => {
  try {
    const res = await axios.get(
      `/api/programs/graduate-programs/department/${id}`
    );

    dispatch({
      type: DEPARTMENT_GRADUATE_PROGRAMS_LOADED,
      payload: res.data
    });
  } catch (err) {
    dispatch({
...
// Enable an undergraduate program by id
