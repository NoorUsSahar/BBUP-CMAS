...
const Dashboard = ({
  ...
  const { challanPicture, amountPaid } = feeDetails;
  ...
  useEffect(() => {
    ...
    setFeeDetails({
      challanPicture:
        !loading && applicant !== null && applicant.feeDetails
          ? applicant.feeDetails.challanPicture
          : '',
      amountPaid:
        !loading && applicant !== null && applicant.feeDetails
          ? applicant.feeDetails.amountPaid
          : ''
    });
  }, [applicant]);
  ...
  const onChangeImage = e => {
    ...
    reader.onload = e => {
      setFeeDetails({ ...feeDetails, [name]: e.target.result });
    };
  ...
  const onSubmit = e => {
    e.preventDefault();
    if (challanPicture === '') {
      setAlert('No picture has been uploaded', 'danger');
    } else {
      updateFeeDetails(feeDetails, history);
      setFeeDetails({ challanPicture: '', amountPaid: '' });
    }
  };
                        ...
                        <Fragment>
                          <div>
                            <p style={{ fontWeight: 'bold' }}>
                              Upload your Profile Picture in Settings tab
                            </p>
                          </div>
                          <div>{`Congratulations! You are on the Merit List of ${programme.programme.name}`}</div>
                          <Link
                            to={`/fee-challan/${applicant && applicant._id}/${
                              programme.programme._id
                            }`}
                            target='_blank'
                          >
                            {`Click here to print admission fee challan for
                          ...
                          <div>
                            ...
                            >
                              Upload the submitted fee challan copy or a picture
                              below the Application Details section for
                    ...
                    <form onSubmit={e => onSubmit(e)}>
                      <GridContainer>
                        <GridItem xs={12} sm={12} md={6}>
                          ...
                          >
                            <FormImage
                              picture={feeDetails.challanPicture}
                              title='Challan Picture'
                            />
                          </Box>
                        </GridItem>
                        <GridItem xs={12} sm={12} md={12}>
                          <div className='file-input'>
                            <p>
                              Upload a picture of your submitted admission
                              challan for verification purposes
                            </p>
                    ...
                    <GridContainer align='center'>
                      <GridItem xs={12} sm={12} md={12}>
                        ...
                        >
                          ...
                          <FormImage
                            picture={
                              educationDetails.intermediateEducationPicture
                            }
...
Dashboard.propTypes = {
  ...
  updateFeeDetails: PropTypes.func.isRequired,
