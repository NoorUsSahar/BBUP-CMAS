export const appointments = [
  {
    ...
    title: 'asembly language',
    startDate: new Date(2018, 5, 29, 10, 0),
    endDate: new Date(2018, 5, 30, 14, 30),
    id: 35,
    location: 'Room 1',
  }, {
    title: 'Entrepunership',
