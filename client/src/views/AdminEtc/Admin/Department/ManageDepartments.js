...
// import { loadDepartmentsAllCoordinator } from '../../actions/coordinator';
    ...
    departmentsList.forEach(department => {
      res = [
        ...
        [
          ...
          <Fragment>
            <Link
              to={`/admin/department-coordinators/${department._id}`}
            ...
            <Link
              to={`/admin/department-programs/${department._id}`}
              className='text-decoration-none'
            >
              <Button
                variant='contained'
