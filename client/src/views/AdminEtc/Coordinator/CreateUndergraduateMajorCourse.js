...
import {
  createUndergraduateMajorCourse,
...
const CreateUndergraduateMajorCourse = ({
  createUndergraduateMajorCourse,
  getAllUndergraduateCourses,
  ...
  const {
    ...
    onSubmit: (values) => {
      if (
        ...
        createUndergraduateMajorCourse(values, history);
      }
    },
  ...
  //     setAlert('Please fill all the fields in order to proceed.');
  //   } else {
  //     createUndergraduateMajorCourse(formData, history);
  //   }
  // };
        ...
        <Card>
          <CardHeader color='primary'>
            <h4 className={classes.cardTitleWhite}>
              Create an Undergraduate Major Course
            </h4>
            <p className={classes.cardCategoryWhite}>
              Fill in the information below to create an undergraduate major
              course
            </p>
          </CardHeader>
          <CardBody>
...
CreateUndergraduateMajorCourse.propTypes = {
  createUndergraduateMajorCourse: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {
  ...
  getAllSections,
  setAlert,
})(withRouter(CreateUndergraduateMajorCourse));
