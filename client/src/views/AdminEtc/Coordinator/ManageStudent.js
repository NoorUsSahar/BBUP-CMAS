  ...
  const getUndergraduateApplicants = () => {
    ...
    undergraduateApplicantList.forEach(undergraduateApplicant => {
      if (
        ...
        undergraduateApplicant.applicantVerified &&
        ...
        res = [
          ...
          [
            ...
            // undergraduateApplicant.applicantVerified ? 'Verified' : 'Pending',
            <Fragment>
              <Link
              ...
              <Link
                to={`/coordinator/manage-student-courses/${undergraduateApplicant._id}`}
                className='text-decoration-none'
              >
                <Button
                  color='primary'
    ...
    <GridContainer>
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          ...
          <CardBody>
            {user !== null && undergraduateApplicantList.length > 0 ? (
              <Table
...
ManageStudents.propTypes = {
  ...
  getAllUndergraduateStudents: PropTypes.func.isRequired,
