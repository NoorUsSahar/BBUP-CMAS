...
const UpdateSection = ({
  ...
  history,
  section: { loading: sectionLoading, sections, section },
  ...
  const {
    ...
    initialValues: {
      name: !sectionLoading && section !== null ? section.name : '',
      maximumStrength:
        !sectionLoading && section !== null ? section.maximumStrength : '',
      currentNumberOfStudents:
        !sectionLoading && section !== null
          ? section.currentNumberOfStudents
          : '',
      semester: !sectionLoading && section !== null ? section.semester : '',
    },
    ...
    onSubmit: (values) => {
      if (values.semester === '') {
        ...
        updateSectionById(match.params.id, values, history);
      }
    },
  ...
  // const [getSectionByIdCalled, setGetSectionByIdCalled] = useState(false);

  useEffect(
    () => {
      // if (!getSectionByIdCalled) {
      getSectionById(match.params.id);
      // setGetSectionByIdCalled(true);
      // }
  ...
  //   } else {
  //     console.log(formData);
  //     updateSectionById(match.params.id, formData, history);
  //   }
  // };
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color='primary'>
            <h4 className={classes.cardTitleWhite}>Update Section</h4>
            <p className={classes.cardCategoryWhite}>
              Fill in the information below to update a section
            </p>
          </CardHeader>
          <CardBody>
...
UpdateSection.propTypes = {
  getSectionById: PropTypes.func.isRequired,
  updateSectionById: PropTypes.func.isRequired,
