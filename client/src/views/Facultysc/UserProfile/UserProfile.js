...
import { getFacultyById } from "../../../actions/facultysc/profile";
                ...
                <CardBody profile>
                  ...
                  <GridContainer>
                      ...
                      <Card>
                        ...
                        <CardBody>
                          {profile.profile.experience.length > 0 ? (
                            ...
                            <h4 className={classes.cardTitle}>No Experience</h4>
                          )}
                        </CardBody>
                      </Card>
                    </GridItem>
                    <GridItem xs={12} sm={12} md={12}>
                      <Card>
                        <CardHeader color="secondary">
                          <h2 className={classes.cardTitle}>Research Papers</h2>
                        </CardHeader>
                        <CardBody>
                      ...
                      <Card>
                        ...
                        <CardBody>
                          {profile.profile.education.length > 0 ? (
                            ...
                            <h4 className={classes.cardTitle}>No Education</h4>
                          )}
                        </CardBody>
                      </Card>
                    </GridItem>
