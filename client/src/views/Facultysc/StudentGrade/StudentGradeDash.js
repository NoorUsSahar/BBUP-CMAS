...
import { getCurrentProfile , getProfiles} from "../../../actions/facultysc/studentgrade";
...
const Dashboard = ({
  getCurrentProfile,
  auth: { users },
  student_grade: { student_profile, student_profiles, loading },
  getProfiles,
  ...
  return loading && student_profile === null ? (
    <Spinner />
  ) : (
    <Fragment>
      <GridContainer>
                                               ...
                                               <GridContainer>
                                                 ...
                                                 <GridItem xs={12} sm={6} md={6}>
                                                   <Button
                                                     ...
                                                     round
                                                     variant="outlined"
                                                     href={`/faculty/student/${profile._id}`}
                                                   >
                                                     View Profile
                                                   </Button>
                                                 </GridItem>
