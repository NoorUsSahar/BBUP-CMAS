            ...
            <CardBody>
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={6}>
                  <Card>
                    <CardHeader color="info">
                      <h4 className={classes.cardTitleBlack}>iCP</h4>
                    </CardHeader>
                    <CardBody>
                ...
                <GridItem xs={12} sm={12} md={6}>
                  <Card>
                    <CardHeader color="info">
                      <h4 className={classes.cardTitleBlack}>Islamic Studies</h4>
                    </CardHeader>
                    <CardBody>
                ...
                <GridItem xs={12} sm={12} md={6}>
                  <Card>
                    <CardHeader color="info">
                      <h4 className={classes.cardTitleBlack}>English and comprehension </h4>
                    </CardHeader>
                    <CardBody>
                ...
                <GridItem xs={12} sm={12} md={6}>
                  <Card>
                    <CardHeader color="info">
                      <h4 className={classes.cardTitleBlack}>calculas</h4>
                    </CardHeader>
                    <CardBody>
